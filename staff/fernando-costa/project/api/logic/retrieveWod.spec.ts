        ...
        Promise.all([
            ...
            .then(() =>
                User.create({ name: 'Pepe Roni', email: 'pepe@roni.com', password: '123qwe123' })
                    .then((user) =>
                        Promise.all([
                            Wod.create({ name: 'Yolo', category: 'Strength', parts: 
                                new Part({name: '5 ROUNDS', reps: 7, activities: [
                            ...
                            Wod.create({ category: 'Strength', parts: 
                                new Part({name: 'FYS', reps: 2, activities: [
                                    new Activity({name: '10 ROUNDS FOR TIME' , reps: 12}),
                                    new Activity({name: '5 DUAL DB PUSH PRESS' , reps: 2}),    
                                ]
                                })
                            }),
                            Wod.create({ category: 'Normal WOD', parts: 
                                new Part({name: ' YNCM', reps: 7, activities: [
                                    new Activity({name: '2 ROUNDS FOR TIME' , reps: 8}),
                                   
                                ]
                                })
                            }),
                            Wod.create({ name: 'Yolo', category: 'Endurance', parts: 
                                new Part({name: '10 ROUNDS', reps: 10, activities: [
                                    new Activity({name: '10 ROUNDS FOR TIME' , reps: 10}),
                            ...
                            Wod.create({ name: 'YAGNI', category: 'Endurance', parts: 
                                new Part({name: '8 ROUNDS', reps: 9, activities: [
                                    new Activity({name: '10 ROUNDS FOR TIME' , reps: 10}),
                            ...
                            Wod.create({ name: 'Kiss', category: 'Benchmark', parts: 
                                new Part({name: '3 ROUNDS', reps: 5, activities: [
